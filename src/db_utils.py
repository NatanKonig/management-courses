...
def criar_db():
    ...
    try:
        ...
        aluno = Aluno.create(username='Aluno', password='1234', email='aluno@gmail.com', matricula = "202311", nome= 'Aluno', cpf='194.411.780-63', telefone='(61) 2847-8735',data_nascimento='2000-10-09',sexo='Homem')
        professor = Professor.create(username='Professor', password='1234', email='professor@gmail.com', matricula = "202312", nome= 'Professor', cpf='847.949.220-19', telefone='(61) 2848-8785',data_nascimento='1980-10-09',sexo='Homem')
